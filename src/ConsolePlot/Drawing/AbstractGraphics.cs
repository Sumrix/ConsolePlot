...
public abstract class AbstractGraphics<TPen>
{
    ...
    {
        Image = image;
        _clipBounds = new(0, 0, imageWidth, imageHeight);
    ...
    public void SetClip(Rectangle clip)
    {
        ...
        _clipBounds = new(x, y, width, height);
    }

    /// <summary>
    /// Draws a line connecting two points specified by the coordinate pairs.
    /// </summary>
    /// <param name="pen"><see cref="IPointPen" /> that determines the color and style of the line.</param>
